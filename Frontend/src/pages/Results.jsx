...
import { Award, Calendar, BarChart2, CheckCircle, XCircle } from 'lucide-react';
...
const ResultsPage = () => {
    ...
    if (error) return <div className="flex items-center justify-center text-red-500 h-full font-medium">Error: {error}</div>;
